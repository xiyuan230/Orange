...
public interface ProductOrderMapper {
    ...
    @Select("SELECT p_o.*,p.content as product_content,u.nick_name as buyer_name,u.avatar as buyer_avatar FROM (product_order p_o JOIN products p ON p.product_id = p_o.product_id) JOIN users u ON u.openid = p_o.buyer_id WHERE p.seller_id = #{openid}")
